                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td><a target="_blank" href="<?php echo SITE_DISH_IMAGE.$row['image']?>"><img src="<?php echo SITE_DISH_IMAGE.$row['image']?>"/></td>
                            <td><?php $date=strtotime($row['added_on']);
                            echo date('d-m-Y');
                            ?></td>
                            <td>
                            <a href="manage_dish.php?id=<?php echo $row['id']?>"><label class="badge badge-success hand_curosr">Edit</label></a>
                            &nbsp;
                              <?php
                            if($row['status']==1)
                            {?>
