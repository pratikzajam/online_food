...
<div class="row">
			<h1 class="card-title grid_title ml15">Manage Category</h1>
                ...
                <div class="card-body">
                  <form class="forms-sample" method="Post">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="category" value="<?php echo $category?>" required placeholder="Name">
                    </div>
                  <div class="error mt8">  <?php echo $msg ?> </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Order Number</label>
                      <input type="textbox" name="order_number" required class="form-control" id="exampleInputEmail3" placeholder="order_number">
                    </div>
