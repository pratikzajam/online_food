...
if(isset($_POST['submit'])){
	...
	$dish_detail=get_safe_value($_POST['dish_details']);
	...
	if(mysqli_num_rows(mysqli_query($con,$sql))>0){
		...
		if($id==''){
			...
			if($image_error==''){
				$sql="update dish set category_id='$category_id', dish='$dish' , dish_details='$dish_detail' $image_condition where id='$id'";
